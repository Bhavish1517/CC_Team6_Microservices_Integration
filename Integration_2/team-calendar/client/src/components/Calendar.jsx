...
import { fetchEvents, createEvent, updateEvent, deleteEvent, syncLabsToCalendar } from '../services/eventService';
...
function CalendarApp() {
  ...
  const handleRefresh = async () => {
    try {
      await syncLabsToCalendar();     // Sync from /8004/albs
      await loadEvents();             // Reload updated events
    } catch (err) {
      setError('Failed to sync labs or refresh events.');
